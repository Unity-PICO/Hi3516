...
#include "rp-lcd-mipi-5inch-720x1280-v2.h"
#include "rp-lcd-mipi-5.5inch-720x1280.h"
#include "rp-lcd-mipi-5.5inch-1080x1920.h"
#include "rp-lcd-mipi-5.5inch-new-720x1280.h"
#include "rp-lcd-mipi-4inch-480x800.h"
#include "rp-lcd-mipi-7inch-800x1280.h"
#include "rp-lcd-mipi-8inch-800x1280-ILI9881C.h"
#include "rp-lcd-mipi-10inch-800x1280-new.h"
...
HI_S32 SAMPLE_COMM_VO_StartVO(SAMPLE_VO_CONFIG_S *pstVoConfig)
{
    ...
    ********************************************/
	...
	// VO_INTF_TYPE_E         enVoIntfType   = VO_INTF_MIPI;
