...
ISP_PUB_ATTR_S GALAXYCORE_GC2093_MIPI_2M_30FPS =
{
	{0, 0, 1920, 1080},
    {1920, 1080},
    30,
...
//added gc2093 by rpdzkj lixin
ISP_PUB_ATTR_S GALAXYCORE_GC2093_MIPI_2M_30FPS_WDR2TO1 =
{
	{0, 0, 1920, 1080},
    {1920, 1080},
    30,
...
HI_S32 SAMPLE_COMM_ISP_GetIspAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, ISP_PUB_ATTR_S* pstPubAttr)
{
    switch (enSnsType)
    {
		...
		case GALAXYCORE_GC2093_MIPI_2M_30FPS_12BIT:
			memcpy(pstPubAttr, &GALAXYCORE_GC2093_MIPI_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
			break;
			
		//added gc2093 by rpdzkj lixin
		case GALAXYCORE_GC2093_MIPI_2M_30FPS_12BIT_WDR2TO1:
			memcpy(pstPubAttr, &GALAXYCORE_GC2093_MIPI_2M_30FPS_WDR2TO1, sizeof(ISP_PUB_ATTR_S));
			break;
