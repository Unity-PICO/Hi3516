...
/* added by rpdzk lixin for selecting sensor refering to parameter from sample_vio, default type form makefile.param */
...
combo_dev_attr_t MIPI_2lane_CHN0_SENSOR_GC2093_12BIT_2M_NOWDR_ATTR =
{
	.devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
//added gc2093 by rpdzkj lixin
combo_dev_attr_t MIPI_2lane_CHN1_SENSOR_GC2093_12BIT_2M_NOWDR_ATTR =
{
	.devno = 1,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
//added gc2093_wdr2to1 by rpdzkj lixin
combo_dev_attr_t MIPI_2lane_CHN0_SENSOR_GC2093_12BIT_2M_WDR2TO1_ATTR =
{
	.devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
//added gc2093_wdr2to1 by rpdzkj lixin
combo_dev_attr_t MIPI_2lane_CHN1_SENSOR_GC2093_12BIT_2M_WDR2TO1_ATTR =
{
	.devno = 1,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
HI_S32 SAMPLE_COMM_VI_GetComboAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, combo_dev_t MipiDev, combo_dev_attr_t* pstComboAttr)
{
    switch (enSnsType)
    {
		...
		//added gc2093 by rpdzkj lixin	
		case GALAXYCORE_GC2093_MIPI_2M_30FPS_12BIT:
			if(0 == MipiDev){
				memcpy(pstComboAttr, &MIPI_2lane_CHN0_SENSOR_GC2093_12BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
			}
			else if(1 == MipiDev){
				memcpy(pstComboAttr, &MIPI_2lane_CHN1_SENSOR_GC2093_12BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
			}
			
            break;
			
		//added gc2093_wdr2to1 by rpdzkj lixin	
		case GALAXYCORE_GC2093_MIPI_2M_30FPS_12BIT_WDR2TO1:
			if(0 == MipiDev){
				memcpy(pstComboAttr, &MIPI_2lane_CHN0_SENSOR_GC2093_12BIT_2M_WDR2TO1_ATTR, sizeof(combo_dev_attr_t));
			}
			else if(1 == MipiDev){
				memcpy(pstComboAttr, &MIPI_2lane_CHN1_SENSOR_GC2093_12BIT_2M_WDR2TO1_ATTR, sizeof(combo_dev_attr_t));
			}
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S* pstViDevAttr)
{
    switch (enSnsType)
    {
		...
		//added gc2093 by rpdzkj lixin
		 case GALAXYCORE_GC2093_MIPI_2M_30FPS_12BIT:
		 case GALAXYCORE_GC2093_MIPI_2M_30FPS_12BIT_WDR2TO1:
			hi_memcpy(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_GC2093_2M_BASE, sizeof(VI_DEV_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetSizeBySensor(SAMPLE_SNS_TYPE_E enMode, PIC_SIZE_E* penSize)
{
    ...
    switch (enMode)
    {
		...
		case GALAXYCORE_GC2093_MIPI_2M_30FPS_12BIT:
		case GALAXYCORE_GC2093_MIPI_2M_30FPS_12BIT_WDR2TO1:
		// printf("sample_comm_vi set pensize ==================\n");
			*penSize = PIC_1080P;
			break;
        default:
            *penSize = PIC_1080P;
